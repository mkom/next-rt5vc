...
import CustomThemeProviderSecond from '../../components/CustomThemeSecond.js';
                        ...
                        {currentPageData.map((house, index) => (  
                            <tr key={index} className="bg-white ">
                                ...
                                <td className="py-2 px-2 ">
                                  ...
                                  <Button color="gray" size="xs" className=' rounded-md' onClick={() => openDetail(house)}>Detail</Button>
